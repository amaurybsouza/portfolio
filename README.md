...
I am a Lead Cloud Security Engineer, Professor & Tech Writer, recognized by two of the largest technology companies in the world (AWS, & Hashicorp). Passionate about AI/ML, modernizing cloud environments. Specializing in Cloud Security,, specializing in Cloud Security, Automations & AI/ML Solutions. Currently, I serve as a Information Seurity Cloud, Expert at CI&T, supporting Growth Units (Business Units). Previously, I worked as a Senior DevOps Engineer at IBM/Kyndryl, where I held multiple leadership roles across Latin America. My career has focused on leading high-performance infrastructure teams and partnering with clients to drive successful digital transformations. To discuss further, please connect with me on my [LinkedIn](https://www.linkedin.com/in/amaurybsouza/).
