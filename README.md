...
As an experienced {👨‍💻Lead/DevOps Engineer} with over 10 years of hands-on expertise in infrastructure and cloud platforms, I currently specialize in SRE/DevOps and Infrastructure as Code (IaC) Engineering. I'm always eager to learn about new technologies and have a strong background in Linux systems, including Red Hat Linux, CentOS, and Debian. I have a deep understanding of cloud infrastructure, automation, and configuration management tools, which enables me to streamline development workflows and accelerate software delivery. I'm proficient in implementing and managing scalable and robust CI/CD pipelines on AWS/Azure platforms. Although english is not my primary language, I'm advanced in both portuguese and english."
